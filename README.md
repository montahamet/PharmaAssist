...
git clone https://github.com/your-username/PharmaAssist.git
cd PharmaAssist
Install Dependencies: A comprehensive list of required libraries:
...
API Key: Enter your confidential Groq API Key into the designated password field.

Document Upload: Upload one or more pharmaceutical PDF documents.

Query: Enter your specific research question into the text box.

Answer: The system will return an answer strictly based on the context of your uploaded documents.
